...
<frameset rows="125,*" name="topFrameset" border="0">
	...
	<frameset cols="202,*" height="100%" name="middle" frameborder="no" border="0" framespacing="0">
		<frame name="leftFrame" class="leftFrame" target="main" scrolling="no" src="homeAction_toleft.html?moduleName=home" />
		<frame name="main" class="rightFrame" src="homeAction_tomain.html?moduleName=home" />
	</frameset>
</frameset>

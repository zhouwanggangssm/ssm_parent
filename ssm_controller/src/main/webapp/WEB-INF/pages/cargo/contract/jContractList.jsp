...
<head>
	...
	<script type="text/javascript">
      ...
      function checks() {
          ...
          if (check == true) {
              //查看
              formSubmit('/cargo/contract_toview', '_self');
          }else {
        ...
        function des() {
            ...
            if (ss == true) {
                if(confirm("你确定要删除吗？")){
                    formSubmit('/cargo/contract_delete','_self');
                }
            }else{
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        ...
        function aaa() {
            ...
            if (aa == true) {
                //修改
                formSubmit('/cargo/contract_toupdateUI','_self');
            }else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
        ...
        function bbb() {
            ...
            if (bb == true) {
                //提交
                formSubmit('/cargo/contract_submit','_self');
            }else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
        ...
        function ccc() {
            ...
            if (cc == true) {
                //取消
                formSubmit('/cargo/contract_cancel','_self');
            }else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
        ...
        function ddd() {
            ...
            if (dd == true) {
                //打印
                formSubmit('/cargo/contract_print','_self');
            }else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
        ...
        function eeee() {
            var ee = $("input[type='checkbox']").is(':checked');
            if (ee == true) {
                //归档
                formSubmit('${ctx}/cargo/contracthis/pigeinhole','_self');
            }else {
                alert("请先选择一项并且只能选择一项，再进行操作！");
            }
        }
...
<div id="innerMenubar">
  <div id="navMenubar">
	<ul>
		...
		<li id="new"><a href="#" onclick="eeee();this.blur();">归档</a></li>
	</ul>
  </div>
</div>
</div>
